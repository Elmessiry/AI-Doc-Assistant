...
Sentry.init({
  ...
  // Trace everything in development; sample in production — 100% tracing
  // ships a payload per page load through our own /monitoring tunnel,
  // burning Sentry quota and hosting bill linearly with traffic.
